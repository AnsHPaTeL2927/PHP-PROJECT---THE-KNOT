        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="Addpackages" method="post" action="admin_Food.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="event_type">
                      <select class="eve_section" name="event_type" required>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Food & Baverages</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
