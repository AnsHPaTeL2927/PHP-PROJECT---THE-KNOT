<?php
include 'admin_Entertainment_DB.php';
...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="admin_css/entertainment.css">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="Addpackages" method="post" action="admin_Entertainment.php">
                <div class="card-body">
