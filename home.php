...
<body>
  ...
  <section id="hero" class="hero">
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hide">
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Events</h2>
          <p>The Best Events aren't just Memorable, They are just Beautiful</p>
        </div>

        <div class="row gy-4">
          <div class="col-lg-6 ">
            <h3>Engagement</h3>
            <img src="assets\img\eg1.jpg" class="img-fluid rounded-4 mb-4 " style="height: 500px; width: 520px;"
              alt="">
          ...
          <div class="col-lg-6">
            <h3>Garba Nights</h3>
            <img src="assets\img\gn2.webp" class="img-fluid rounded-4 mb-4 " style="height: 500px; width: 520px;"
              alt="">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <h3>Wedding</h3>
            <img src="assets\img\wedding.jpg" class="img-fluid rounded-4 mb-4 " style="height: 500px; width: 520px;"
              alt="">
            <div class="content ps-0 ps-lg-1">
              <p class="fst-italic">
          ...
          <div class="col-lg-6">
            <h3>Reception</h3>
            <img src="assets\img\RECEPTION.jpg" class="img-fluid rounded-4 mb-4 "
    ...
    <!-- ======= Contact Section ======= -->
    <section id="contact" class="contact" style="background-color: #f6f6f6;">
      <div class="container" data-aos="fade-up">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container mt-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Knot</span></strong>. All Rights Reserved.
      </div>
    </div>
