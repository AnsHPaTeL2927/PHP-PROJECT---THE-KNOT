...
<head>
  ...
  <link rel="stylesheet" href="bill_2.css">
    ...
    <div class="col-50 hide">
      <div class="container1">
        <form action="bill_2.php" method="post">
          ...
          <button  type="submit" name="submit" class="btn" onclick="document.getElementById('id02').style.display='block'">Continue to checkout</button>
        </form>
      </div>
    </div>
    <!-- ----------------------------------------------------------------------------- -->
    <div id="id02" class="w3-modal">
      <div class="w3-modal-content w3-modal-content1">
        <header class="w3-container w3-container1 w3-teal"> 
          <!-- <span onclick="document.getElementById('id01').style.display='none'" 
          class="w3-button w3-display-topright">&times;</span> -->
          <h2>Payment successfull</h2>
        </header>
        <div class="w3-container w3-container1 msg1">
          <div class="">
            <i class="fa fa-check" style="font-size:100px;color:rgb(60, 139, 101)"></i>
            
          </div>
        </div>
        <footer class="w3-container w3-container1 ">
          <a href="view_pdf.php">
          ...
          <a href="">
            <button type="submit" onclick="document.getElementById('id02').style.display='none'"  class="btn btn-success">
              Close
            </button>
          </a>
        </footer>
    ...
    <div class="col-50">
      <div class="container1 col-25">
        ...
        <div class="btn-display">
          ...
          <input type="submit" value="Continue to checkout" class="btn btn-show btn-hide btn2" onclick="document.getElementById('id02').style.display='block'">
        </div>
      </div>
    </div>
      ...
      <div id="id01" class="w3-modal">
        <div class="w3-modal-content w3-animate-top w3-card-3">
          ...
          <div class="w3-container">
            ...
            <input type="text" id="ccnum" name="cardnumber" placeholder="1111-2222-3333-4444" required>
            <label for="expmonth">Exp Month</label>
            <input type="number" id="expmonth" name="expmonth" placeholder="September" required>
            <div class="row">
              <div class="col-50">
                <label for="expyear">Exp Year</label>
          ...
          <button type="submit" name="submit" class="btn btn2" >Continue to checkout</button>
        </div>
      </div>
    </form>
  </div>
