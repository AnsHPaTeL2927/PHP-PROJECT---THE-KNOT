<?php
include 'admin_Photography_DB.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="admin_css/Photography.css">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="Addpackages" method="post" action="admin_photography.php">
                <div class="card-body">
